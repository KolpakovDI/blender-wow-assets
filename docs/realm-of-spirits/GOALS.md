...
12. **Next (год C+A):** `YEAR-PLAN-2026-10.md` — Q1/Q2 scaffolding PASS; **E1 OWNER SKIP** 16.08; **Q3 Slice 1** fair duel harden 16.08f (`SESSION-2026-08-16f-q3-duel.md`); Allow* только явным unlock.
