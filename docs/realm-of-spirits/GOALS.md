...
12. **Next (год C+A):** `YEAR-PLAN-2026-10.md` — Q1/Q2 scaffolding PASS; **E1 OWNER SKIP** 16.08 (`E1-HANDS-LOG.md`); дальше Q3 PvP/Haven или дожим квестов; Allow* только явным unlock.
