# Project skills — Realm of Spirits

These skills teach the agent how to work efficiently on this repo.
...
Invoke by name in chat (e.g. «используй realm-orchestrator») or by working on matching topics (descriptions are discovery triggers).
